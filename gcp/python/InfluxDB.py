...
def build_field_list(fr):
    ...
    r = {
         ...
         'linsens_avg_l1': ['TrackerPointing', 'linsens_avg_l1',
                            core.G3Units.mm],
         'linsens_avg_l2': ['TrackerPointing', 'linsens_avg_l2',
                            core.G3Units.mm],
         'linsens_avg_r1': ['TrackerPointing', 'linsens_avg_r1',
                            core.G3Units.mm],
         'linsens_avg_r2': ['TrackerPointing', 'linsens_avg_r2',
                            core.G3Units.mm],
        # Weather
        ...
        # Online Pointing Model
         'tilts_hr_angle': ['OnlinePointingModel', 'tilts', 0,
                            core.G3Units.deg],
         'tilts_lat': ['OnlinePointingModel', 'tilts', 1,
                       core.G3Units.deg],
        ...
        # Bench
         ...
         'bench_actual_y2': ['BenchPosition', 'y2', core.G3Units.mm],
         'bench_actual_y3': ['BenchPosition', 'y3', core.G3Units.mm],
         'bench_actual_x4': ['BenchPosition', 'x4', core.G3Units.mm],
         'bench_actual_x5': ['BenchPosition', 'x5', core.G3Units.mm],
         'bench_actual_z6': ['BenchPosition', 'z6', core.G3Units.mm],

         'bench_zero_y1': ['BenchZeros', 'y1', core.G3Units.mm],
         'bench_zero_y2': ['BenchZeros', 'y2', core.G3Units.mm],
         'bench_zero_y3': ['BenchZeros', 'y3', core.G3Units.mm],
         'bench_zero_x4': ['BenchZeros', 'x4', core.G3Units.mm],
         'bench_zero_x5': ['BenchZeros', 'x5', core.G3Units.mm],
         'bench_zero_z6': ['BenchZeros', 'z6', core.G3Units.mm],

         'bench_offset_y1': ['BenchOffsets', 'y1', core.G3Units.mm],
         'bench_offset_y2': ['BenchOffsets', 'y2', core.G3Units.mm],
         'bench_offset_y3': ['BenchOffsets', 'y3', core.G3Units.mm],
         'bench_offset_x4': ['BenchOffsets', 'x4', core.G3Units.mm],
         'bench_offset_x5': ['BenchOffsets', 'x5', core.G3Units.mm],
         'bench_offset_z6': ['BenchOffsets', 'z6', core.G3Units.mm],

         'bench_error_y1': ['BenchErrors', 'y1', core.G3Units.mm],
         'bench_error_y2': ['BenchErrors', 'y2', core.G3Units.mm],
         'bench_error_y3': ['BenchErrors', 'y3', core.G3Units.mm],
         'bench_error_x4': ['BenchErrors', 'x4', core.G3Units.mm],
         'bench_error_x5': ['BenchErrors', 'x5', core.G3Units.mm],
         'bench_error_z6': ['BenchErrors', 'z6', core.G3Units.mm],
    ...
    scu_temps = {0: 'yoke_air', 1: 'ctrl_room_air', 2: 'glycol_supply',
                 ...
                 21: 'icecrate', 22: 'bench', 23: 'attic', 24: 'cabin',
                 25: 'cryoboard'}
    for i in range(60):
        if i in scu_temps:
            r['t_scu_{}'.format(scu_temps[i])] = \
    ...
    for f in fields:
        ...
        if len(field_dat) == 4:
            ...
            if 'Bench' in stat: # funny time field for bench positions
                time = fr['antenna0']['scu']['benchSampleTime'][0]
            else:
                time = getattr(fr[stat], 'time')
        ...
        if unit is not None:
            if unit == 'C':
                zeropt_K = 273.15
                cal_dat = dat / core.G3Units.K - zeropt_K
            else:
                cal_dat = dat / unit
        else:
            cal_dat = dat
        ...
        dict_list += make_lines(measurement=stat, field=f,
    ...
    try:
        ...
        if delay > 5:
            core.log_info('{} Delay: {} s'.format(
                dt.datetime.now(), delay), unit='InfluxDB')
