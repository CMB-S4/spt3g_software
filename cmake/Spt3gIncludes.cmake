...
macro(add_spt3g_library lib_name)
	...
	file(REMOVE ${CMAKE_BINARY_DIR}/spt3g/libspt3g-${lib_name}.so)
	file(REMOVE ${CMAKE_BINARY_DIR}/spt3g/libspt3g-${lib_name}.dylib)
...
macro(add_spt3g_test test_name)
	...
	if(NOT DEFINED ENV{CIBUILDWHEEL})
		...
		set_tests_properties(${PROJECT}/${test_name} PROPERTIES ENVIRONMENT
			"PATH=${CMAKE_BINARY_DIR}/bin:$ENV{PATH};PYTHONPATH=${CMAKE_BINARY_DIR}:$ENV{PYTHONPATH};LD_LIBRARY_PATH=${CMAKE_BINARY_DIR}/lib:${CMAKE_BINARY_DIR}/spt3g:$ENV{LD_LIBRARY_PATH}")
	endif()
	if (${num_extra_args} GREATER 0)
