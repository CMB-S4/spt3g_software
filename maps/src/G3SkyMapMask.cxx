...
PYBINDINGS("maps")
{
	...
	EXPORT_FRAMEOBJECT(G3SkyMapMask, init<const G3SkyMap &>(),
	  ...
	  .def<bool (G3SkyMapMask::*)(const G3SkyMapMask &)>("compatible", &G3SkyMapMask::IsCompatible, "Returns true if the two masks can be applied to the same map.")
	  .def<bool (G3SkyMapMask::*)(const G3SkyMap &)>("compatible", &G3SkyMapMask::IsCompatible, "Returns true if this mask can be applied to the given map.")
